...
export TRACE_DIR=$TRACES/ai_benchmarks
export JOB_TIME="3-00:00:00"

sbatch --dependency=afterok:$BUILD_JOB_ID --time=$JOB_TIME --array=0-2 --mail-type=$MAIL_TYPE --mail-user=$MAIL_USER trace_array.slurm
